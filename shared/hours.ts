/**
 * Restoran ish vaqti — YAGONA manba.
 *
 * Bu fayl ikkala tomonga ham xizmat qiladi:
 *   • mijoz ilovasi (`src/utils/hours.ts` shu yerdan qayta eksport qiladi)
 *   • server (`api/_lib/hours.ts` ham shu yerdan)
 *
 * Ilgari bir xil ~190 satr kod ikki faylda nusxalangan edi va fayllarning
 * o'zida "birini o'zgartirsangiz, ikkinchisini ham yangilang" deb yozib
 * qo'yilgandi. Bunday qo'lda sinxronlash ertami-kechmi buziladi —
 * natijada server "yopiq", mijoz esa "ochiq" deb ko'rsatadigan holat
 * yuzaga kelardi.
 */
