...
export const uz = {
  ...
  'product.withContainer': 'Idish bilan',
  'product.containerNote': 'Idishi bilan beriladi — porsiyasiga +{price}',
  ...
  'checkout.containers': 'Idishlar',
  'checkout.howToGet': 'Buyurtmani qanday olasiz?',
  'checkout.wayDelivery': 'Yetkazib berish',
  'checkout.wayPickup': 'Olib ketish',
  'checkout.pickup': 'Olib ketish',
  'checkout.contactInfo': "Aloqa ma'lumotlari",
  'checkout.pickupWhere': 'Qayerdan olasiz',
  'checkout.pickupAskPhone': "Manzil ko'rsatilmagan — telefon orqali aniqlashtiring",
  'checkout.pickupReadyNote': "Buyurtma tayyor bo'lganda sizga xabar keladi",
  'checkout.pickupPayNote': "Buyurtmani olganingizda to'laysiz",
  ...
  'statusPickup.Qabul qilindi': 'Tayyorlanmoqda',
  'statusPickup.Yetkazilmoqda': 'Tayyor',
  'statusPickup.Yetkazildi': 'Topshirildi',
