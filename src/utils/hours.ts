 ...
 *
 * MUHIM: bu faylning egizagi — `api/_lib/hours.ts`. Server buyurtmani
 * qabul qilishdan oldin xuddi shu qoidani qayta tekshiradi (mijozga
 * ishonib bo'lmaydi). Birini o'zgartirsangiz, ikkinchisini ham yangilang.
 */
